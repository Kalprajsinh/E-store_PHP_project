...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (mysqli_num_rows($run_username) >= 1) {
    ...
    if (mysqli_num_rows($run_email) >= 1) {
      ...
      $sql = "INSERT INTO `userinfo` (`name`, `email`, `username`, `password`) VALUES ('$name', '$email', '$username', '$phash')";
    ...
    <form class="form-horizontal" action="" method="post">
      <div class="form-group">
        <div class="col-sm-10">
          ...
          <input type="text" class="form-control" placeholder="Enter Name" name="name" id="validationCustom03" required>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="pwd">Email:</label>
        <div class="col-sm-10">
          <input type="email" class="form-control" id="pwd" placeholder="Enter Email" name="email" id="validationCustom03" required>
        </div>
      </div>
      <div class="form-group">
